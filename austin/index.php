  ...
  <div id="drawer-contents" class="container">
    ...
    <div class="container">
      <div class="row">
        ...
        <div id="connect-button" class="col-md-1"><img src="../images/connect2x.png" width="90" height="74" /></div>
      </div>
    </div>
</div>
  ...
  <!--<div class="row">
    <div class="col-lg-12 col-md-12">
      ...
      <div id="Carousel" class="carousel slide carousel-fade">
            ...
            <img src="../images/austin1.jpg" class="img-responsive" alt="Responsive image">
                </div>
                <div class="item">
            <img src="../images/austin2.jpg" class="img-responsive" alt="Responsive image">
                </div>
                
               <div class="item">
            <img src="../images/austin3.jpg" class="img-responsive" alt="Responsive image">
                </div>
    
                <div class="item">
            <img src="../images/austin4.jpg" class="img-responsive" alt="Responsive image">
                </div>
            </div>
 ...
 <div class="container">
  ...
  <div class="row">
      ...
      <div class="col-xs-12">
          <div class="location-header">
            ...
            <h2 class="text-center">SALTY SOW AUSTIN</h2>
  ...
  <div class="row">
    <div class="col-sm-8 col-md-8">
      <div class="welcome">
        <h3>welcome</h3>
        <p>Housed in what once was a general store operated by legendary jazz pianist, Robert Shaw, Salty Sow is nestled in Austin's East Side just blocks from downtown and the University of Texas. Located at Manor Road and Dean Keaton, parking on-site.</p>
          	<div class="reservations">
            <span class="reservations-button"><a href="http://www.opentable.com/the-salty-sow-reservations-austin?rid=86803&restref=86803" target="_blank">Get Reservations</a></span>
           <div id="powered">
      ...
      <div class="col-xs-12 col-sm-4 col-md-4">
        ...
        <div class="map-wrapper">
          <div class="map"> 
            <div id="map"></div> 
              <p class="adress">1917 Manor Rd.<br />
              Austin, TX 78722</p>
              <p class="number">(512) 391-2337</p>
                <a href="https://maps.google.com/maps?q=1917+Manor+Rd.+Austin,+TX+78722&hl=en&sll=33.59784,-111.978111&sspn=0.022377,0.023239&gl=us&hnear=1917+Manor+Rd,+Austin,+Texas+78722&t=m&z=17"><p class="directions">Get Directions</p></a>
  ...
  close: function(){} // Function: Close callback
   ...
   <script type="text/javascript"> 
     ...
     var map = new google.maps.Map(document.getElementById('map'), {
       ...
       center: new google.maps.LatLng(30.28379,-97.721359),
       zoom: 18,
       mapTypeId: 'mystyle'
     });
